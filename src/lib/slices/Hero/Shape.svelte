...
<Environment files="metronord.hdr" path="/" format="hdr" />

<ContactShadows position={[0, -3.5, 0]} opacity={0.65} scale={40} blur={1} far={9} />

<!-- Gem -->
<Geometry position={[0.3, 0, 0]} rate={0.3} geometry={new THREE.SphereGeometry(2, 22, 2)} />
...
<!-- Diamond -->
<Geometry position={[1.6, 2, -4]} rate={0.7} geometry={new THREE.OctahedronGeometry(1.5)} />